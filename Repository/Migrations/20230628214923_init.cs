    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentExistances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentExistances_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentExistances_Users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExistances_LessonId",
                table: "StudentExistances",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentExistances_StudentId",
                table: "StudentExistances",
                column: "StudentId");
